...
class GaussianCTHMM(_BaseTEBM):
    ...
    def _compute_log_likelihood_S(self, i, j):
    ...
    def predict(self, X, lengths=None, jumps=None):
        ...
        self.jumps = jumps
        logprob, state_sequence = self.decode()
    ...
    def predict_proba(self, X, lengths=None, jumps=None):
        ...
        for i, j in iter_from_X_lengths(self.X, self.lengths):
            _, posteriors[i:j] = self.score_samples(i, j)
        return posteriors
...
class MultinomialCTHMM(_BaseTEBM):
