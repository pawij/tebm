...
__all__ = ["MixtureCTHMM", "MultinomialCTHMM", "GMMCTHMM"]
...
class GaussianCTHMM(BaseTEBM):
    ...
    """
    def __init__(self, X=None, lengths=None, 
        ...
        BaseTEBM.__init__(self, X=X, lengths=lengths, 
    ...
    def _compute_log_likelihood(self, X, i, j):
        return log_multivariate_normal_density(
            self.X[i:j], self.means_, self._covars_, self.covariance_type)

    def predict(self, X, lengths=None):
        # FIXME: is there a general way of doing this?
        self.X = X
        self.lengths = lengths
        logprob, state_sequence = self.decode(X, lengths)
...
class MultinomialCTHMM(BaseTEBM):
    ...
    def __init__(self, n_components=1,
        ...
        BaseTEBM.__init__(self, n_components,
